...
public class Retangulo {
	...
	public static void main(String[] args) {
		...
		/* Função Math.sqrt: função de raiz quadrada | Função Math.pow: função de potenciação */
		
		System.out.println("Area = " + String.format("%.4f", area));
		/* Função String.format: formata casas decimais "%.4f", neste caso 4 é o número de casas decimais */
